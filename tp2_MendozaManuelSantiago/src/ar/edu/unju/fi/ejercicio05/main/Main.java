...
public class Main {
	...
	private static void cargaProductos(List<Productos> productos) {
	...
	private static void compra(Scanner leerscaner,List<Productos> productos){
	...
	//se muestra los productos
	 private static void mostrarProductos(List<Productos> productos) {
